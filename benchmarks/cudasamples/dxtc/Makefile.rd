...
dxtc.o:dxtc.cu
	$(EXEC) $(NVCC) $(CURD_CFLAGS) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<

dxtc: dxtc.o
	$(EXEC) $(NVCC) $(CURD_FLAGS_LAZY) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $@_lazy $+ $(LIBRARIES)
	$(EXEC) $(NVCC) $(CURD_FLAGS_EAGER) $(ALL_LDFLAGS) $(GENCODE_FLAGS) -o $@_eager $+ $(LIBRARIES)
...
clean:
	rm -f dxtc_eager dxtc_lazy dxtc.o
