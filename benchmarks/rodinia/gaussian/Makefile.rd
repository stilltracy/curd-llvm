...
all:
	nvcc $(CURD_FLAGS_LAZY) -O2 -lineinfo -D_FORCE_INLINES -arch=sm_35 --cudart=shared gaussian.cu -o gaussian_lazy
	nvcc $(CURD_FLAGS_EAGER) -O2 -lineinfo -D_FORCE_INLINES -arch=sm_35 --cudart=shared gaussian.cu -o gaussian_eager

clean:
	rm -f result.txt gaussian_*
