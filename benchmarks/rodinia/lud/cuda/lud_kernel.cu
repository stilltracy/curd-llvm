...
allocateReadWriteSets(1, BLOCK_SIZE);
      lud_diagonal<<<1, BLOCK_SIZE>>>(m, matrix_dim, i);
freeReadWriteSets(1, BLOCK_SIZE);



allocateReadWriteSets((matrix_dim-i)/BLOCK_SIZE-1, BLOCK_SIZE*2);
      lud_perimeter<<<(matrix_dim-i)/BLOCK_SIZE-1, BLOCK_SIZE*2>>>(m, matrix_dim, i);
freeReadWriteSets((matrix_dim-i)/BLOCK_SIZE-1, BLOCK_SIZE*2);
