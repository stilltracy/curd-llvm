...
allocateReadWriteSets(grid_size, block_size);
...
#endif
                    d_destData, d_cindex);
freeReadWriteSets(grid_size, block_size);
...
allocateReadWriteSets( num_scan_elements/16, 16);
...
freeReadWriteSets( num_scan_elements/16, 16);
