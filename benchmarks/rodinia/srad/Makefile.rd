...
all:
	nvcc $(CURD_FLAGS_LAZY) -O2 -D_FORCE_INLINES -arch=sm_35 --cudart=shared srad.cu -o srad_lazy
	nvcc $(CURD_FLAGS_EAGER) -O2 -D_FORCE_INLINES -arch=sm_35 --cudart=shared srad.cu -o srad_eager
clean:
	rm -f result.txt srad_eager srad_lazy
