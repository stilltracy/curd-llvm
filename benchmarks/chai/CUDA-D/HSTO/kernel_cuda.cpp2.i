...
# 82 "/opt/nvidia8/bin/..//include/device_atomic_functions.h"
 __attribute__((device_builtin)) extern __attribute__((device)) unsigned __uAtomicAdd(unsigned *, unsigned);
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
static __attribute__((device)) __inline__ unsigned _Z9atomicAddPjj(unsigned *, unsigned);
# 45 "kernel_cuda.cu"
__attribute__((global)) extern void _Z16Histogram_kerneliiiPjS_(int, int, int, unsigned *, unsigned *);
# 47 "kernel_cuda.cu"
...
# 49 "kernel_cuda.cu" 2
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
static __attribute__((device)) __inline__ unsigned _Z9atomicAddPjj(
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
unsigned *address,
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
unsigned val){
...
# 45 "kernel_cuda.cu"
__attribute__((global)) void _Z16Histogram_kerneliiiPjS_(
# 45 "kernel_cuda.cu"
int size,
# 45 "kernel_cuda.cu"
int bins,
