...
# 46 "kernel_cuda.cu"
                       extern void _Z14Padding_kerneliiiifPdS_Pi(int __T16, int __T17, int __T18, int __T19, float __T110, double *__T111, double *__T112, int *__T113);
...
__attribute__((global)) __attribute__((__used__)) 
# 46 "kernel_cuda.cu"
                       void _Z14Padding_kerneliiiifPdS_Pi(
# 46 "kernel_cuda.cu"
int n,
# 46 "kernel_cuda.cu"
int m,
...
# 51 "kernel_cuda.cu"
 Partitioner __T20;
# 61 "kernel_cuda.cu"
 Partitioner __cuda_local_var_16938_17_non_const_p;
# 64 "kernel_cuda.cu"
 int __cuda_local_var_16941_15_non_const_matrix_size;
# 65 "kernel_cuda.cu"
 int __cuda_local_var_16942_15_non_const_matrix_size_align;
# 61 "kernel_cuda.cu"
memset(((char *)(&__cuda_local_var_16938_17_non_const_p)), 0, 12UL);
# 61 "kernel_cuda.cu"
__cuda_local_var_16938_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , ((void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)(__float2int_rz(((double)((float)(((float)(__T20.n_tasks)) * alpha)))))))) : ((void)0)))) , __T20);
# 64 "kernel_cuda.cu"
__cuda_local_var_16941_15_non_const_matrix_size = (m * (n + pad));
# 65 "kernel_cuda.cu"
__cuda_local_var_16942_15_non_const_matrix_size_align = ((int)((((((unsigned)__cuda_local_var_16941_15_non_const_matrix_size) + ((blockDim.x) * 32U)) - 1U) / ((blockDim.x) * 32U)) * ((blockDim.x) * 32U)));
# 65 "kernel_cuda.cu"
{
# 68 "kernel_cuda.cu"
 int my_s;
# 68 "kernel_cuda.cu"
my_s = (((__cuda_local_var_16938_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_16938_17_non_const_p.cut)) + (blockIdx.x)))) , (__cuda_local_var_16938_17_non_const_p.current)); {
# 68 "kernel_cuda.cu"
for (; ((__nv_bool)((((const Partitioner *)(&__cuda_local_var_16938_17_non_const_p))->current) < (((const Partitioner *)(&__cuda_local_var_16938_17_non_const_p))->n_tasks))); my_s = (((__cuda_local_var_16938_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_16938_17_non_const_p.current)) + (gridDim.x)))) , (__cuda_local_var_16938_17_non_const_p.current)))
# 68 "kernel_cuda.cu"
{
# 71 "kernel_cuda.cu"
 double __cuda_local_var_16948_16_non_const_reg[32];
# 72 "kernel_cuda.cu"
 int __cuda_local_var_16949_13_non_const_pos;
# 73 "kernel_cuda.cu"
 int __cuda_local_var_16950_13_non_const_my_s_row;
# 74 "kernel_cuda.cu"
 int __cuda_local_var_16951_13_non_const_my_x;
# 75 "kernel_cuda.cu"
 int __cuda_local_var_16952_13_non_const_pos2;
# 72 "kernel_cuda.cu"
__cuda_local_var_16949_13_non_const_pos = ((int)(((unsigned)(__cuda_local_var_16942_15_non_const_matrix_size_align - 1)) - ((((unsigned)(my_s * 32)) * (blockDim.x)) + (threadIdx.x))));
# 73 "kernel_cuda.cu"
__cuda_local_var_16950_13_non_const_my_s_row = (__cuda_local_var_16949_13_non_const_pos / (n + pad));
# 74 "kernel_cuda.cu"
__cuda_local_var_16951_13_non_const_my_x = (__cuda_local_var_16949_13_non_const_pos % (n + pad));
# 75 "kernel_cuda.cu"
__cuda_local_var_16952_13_non_const_pos2 = ((__cuda_local_var_16950_13_non_const_my_s_row * n) + __cuda_local_var_16951_13_non_const_my_x);
# 75 "kernel_cuda.cu"
{
# 78 "kernel_cuda.cu"
 int j;
...
{ {
# 79 "kernel_cuda.cu"
if (((__cuda_local_var_16952_13_non_const_pos2 >= 0) && (__cuda_local_var_16951_13_non_const_my_x < n)) && (__cuda_local_var_16952_13_non_const_pos2 < __cuda_local_var_16941_15_non_const_matrix_size))
# 79 "kernel_cuda.cu"
{
# 80 "kernel_cuda.cu"
((__cuda_local_var_16948_16_non_const_reg)[j]) = (matrix[__cuda_local_var_16952_13_non_const_pos2]);
# 80 "kernel_cuda.cu"
}
# 80 "kernel_cuda.cu"
else
...
{
# 82 "kernel_cuda.cu"
((__cuda_local_var_16948_16_non_const_reg)[j]) = (0.0);
# 82 "kernel_cuda.cu"
} }
# 83 "kernel_cuda.cu"
__cuda_local_var_16949_13_non_const_pos -= (blockDim.x);
# 84 "kernel_cuda.cu"
__cuda_local_var_16950_13_non_const_my_s_row = (__cuda_local_var_16949_13_non_const_pos / (n + pad));
# 85 "kernel_cuda.cu"
__cuda_local_var_16951_13_non_const_my_x = (__cuda_local_var_16949_13_non_const_pos % (n + pad));
...
{ {
# 98 "kernel_cuda.cu"
while ((__iAtomicAdd((flags + my_s), 0)) == 0)
# 98 "kernel_cuda.cu"
{
# 99 "kernel_cuda.cu"
} }
# 100 "kernel_cuda.cu"
_Z9atomicAddPii((flags + (my_s + 1)), 1);
# 102 "kernel_cuda.cu"
} }
# 103 "kernel_cuda.cu"
__syncthreads();
...
{ {
# 109 "kernel_cuda.cu"
if ((__cuda_local_var_16949_13_non_const_pos >= 0) && (__cuda_local_var_16949_13_non_const_pos < __cuda_local_var_16941_15_non_const_matrix_size))
# 109 "kernel_cuda.cu"
{
# 110 "kernel_cuda.cu"
(matrix_out[__cuda_local_var_16949_13_non_const_pos]) = ((__cuda_local_var_16948_16_non_const_reg)[j]);
# 110 "kernel_cuda.cu"
} }
# 111 "kernel_cuda.cu"
__cuda_local_var_16949_13_non_const_pos -= (blockDim.x);
