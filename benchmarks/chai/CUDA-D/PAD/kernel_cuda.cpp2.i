...
# 46 "kernel_cuda.cu"
                       extern void _Z14Padding_kerneliiiifPdS_Pi(int, int, int, int, float, double *, double *, int *);
...
# 61 "kernel_cuda.cu"
memset((char *)&__cuda_local_var_16938_17_non_const_p, 0,sizeof(__cuda_local_var_16938_17_non_const_p));
# 61 "kernel_cuda.cu"
__cuda_local_var_16938_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , (void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)__float2int_rz((float)((((float)(__T20.n_tasks)) * alpha)))))) : ((void)0))) , __T20);
# 64 "kernel_cuda.cu"
...
# 80 "kernel_cuda.cu"
((__cuda_local_var_16948_16_non_const_reg)[j]) = (matrix[__cuda_local_var_16952_13_non_const_pos2]); } else {
# 82 "kernel_cuda.cu"
