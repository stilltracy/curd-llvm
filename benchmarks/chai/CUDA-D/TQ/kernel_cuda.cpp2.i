...
# 45 "kernel_cuda.cu"
__attribute__((global)) extern void _Z13TaskQueue_gpuP6task_tPiS1_iii(task_t *, int *, int *, int, int, int);
# 48 "kernel_cuda.cu"
...
# 50 "kernel_cuda.cu" 2
# 45 "kernel_cuda.cu"
__attribute__((global)) void _Z13TaskQueue_gpuP6task_tPiS1_iii(
# 45 "kernel_cuda.cu"
task_t *queue,
# 45 "kernel_cuda.cu"
int *data,
