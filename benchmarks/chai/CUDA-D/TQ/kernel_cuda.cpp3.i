...
# 45 "kernel_cuda.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z13TaskQueue_gpuP6task_tPiS1_iii(task_t *, int *, int *, int, int, int);
# 48 "kernel_cuda.cu"
...
# 50 "kernel_cuda.cu" 2
# 45 "kernel_cuda.cu"
__attribute__((global)) __attribute__((__used__)) void _Z13TaskQueue_gpuP6task_tPiS1_iii(
# 45 "kernel_cuda.cu"
task_t *queue,
# 45 "kernel_cuda.cu"
int *data,
...
{
# 49 "kernel_cuda.cu"
 int *__cuda_local_var_16144_10_non_const_next;
# 50 "kernel_cuda.cu"
 task_t *__cuda_local_var_16145_13_non_const_t;
# 52 "kernel_cuda.cu"
 int __cuda_local_var_16147_15_non_const_tid;
# 53 "kernel_cuda.cu"
 int __cuda_local_var_16148_15_non_const_tileid;
# 54 "kernel_cuda.cu"
 int __cuda_local_var_16149_15_non_const_tile_size;
# 49 "kernel_cuda.cu"
__cuda_local_var_16144_10_non_const_next = l_mem;
# 50 "kernel_cuda.cu"
__cuda_local_var_16145_13_non_const_t = ((task_t *)(__cuda_local_var_16144_10_non_const_next + 1));
# 52 "kernel_cuda.cu"
__cuda_local_var_16147_15_non_const_tid = ((int)(threadIdx.x));
# 53 "kernel_cuda.cu"
__cuda_local_var_16148_15_non_const_tileid = ((int)(blockIdx.x));
# 54 "kernel_cuda.cu"
__cuda_local_var_16149_15_non_const_tile_size = ((int)(blockDim.x));
# 57 "kernel_cuda.cu"
if (__cuda_local_var_16147_15_non_const_tid == 0)
# 57 "kernel_cuda.cu"
{
# 58 "kernel_cuda.cu"
(*__cuda_local_var_16144_10_non_const_next) = (__iAtomicAdd(consumed, 1));
# 59 "kernel_cuda.cu"
(__cuda_local_var_16145_13_non_const_t->id) = ((queue[(*__cuda_local_var_16144_10_non_const_next)]).id);
# 60 "kernel_cuda.cu"
(__cuda_local_var_16145_13_non_const_t->op) = ((queue[(*__cuda_local_var_16144_10_non_const_next)]).op);
# 61 "kernel_cuda.cu"
}
# 62 "kernel_cuda.cu"
__syncthreads();
# 63 "kernel_cuda.cu"
while ((*__cuda_local_var_16144_10_non_const_next) < gpuQueueSize)
# 63 "kernel_cuda.cu"
{
# 65 "kernel_cuda.cu"
if ((__cuda_local_var_16145_13_non_const_t->op) == 1)
# 65 "kernel_cuda.cu"
{
# 65 "kernel_cuda.cu"
{
...
{
# 67 "kernel_cuda.cu"
(data[((((__cuda_local_var_16145_13_non_const_t->id) - offset) * __cuda_local_var_16149_15_non_const_tile_size) + __cuda_local_var_16147_15_non_const_tid)]) += __cuda_local_var_16149_15_non_const_tile_size;
# 68 "kernel_cuda.cu"
}
# 68 "kernel_cuda.cu"
}
# 70 "kernel_cuda.cu"
(data[((((__cuda_local_var_16145_13_non_const_t->id) - offset) * __cuda_local_var_16149_15_non_const_tile_size) + __cuda_local_var_16147_15_non_const_tid)]) += (__cuda_local_var_16145_13_non_const_t->id);
# 71 "kernel_cuda.cu"
}
# 72 "kernel_cuda.cu"
if ((__cuda_local_var_16145_13_non_const_t->op) == 2)
# 72 "kernel_cuda.cu"
{
# 72 "kernel_cuda.cu"
{
