...
# 47 "kernel_cuda.cu"
extern int _Z18gen_model_paramGPUiiiiiiiiPf(int __T16, int __T17, int __T18, int __T19, int __T110, int __T111, int __T112, int __T113, float *__T114);
# 72 "kernel_cuda.cu"

# 72 "kernel_cuda.cu" 3
__attribute__((global)) __attribute__((__used__)) 
# 72 "kernel_cuda.cu"
                       extern void _Z19RANSAC_kernel_blockiiififPfP10flowvectorPiS2_S2_S2_(int __T115, int __T116, int __T117, float __T118, int __T119, float __T120, float *__T121, flowvector *__T122, int *__T123, int *__T124, int *__T125, int *__T126);
# 81 "kernel_cuda.cu"
extern 
# 81 "kernel_cuda.cu" 3
...
# 54 "kernel_cuda.cu"
(model_param[0]) = ((float)(fdividef(((double)((float)(((vx1 * ((((((-vx2) * x1) + (vx1 * x2)) - (vx2 * x2)) + (vy2 * y1)) - (vy2 * y2))) + (vy1 * ((((((-vy2) * x1) + (vy1 * x2)) - (vy2 * x2)) - (vx2 * y1)) + (vx2 * y2)))) + (x1 * ((vy2 * vy2) + (vx2 * vx2)))))), ((double)__cuda_local_var_16940_11_non_const_temp))));
# 58 "kernel_cuda.cu"
(model_param[1]) = ((float)(fdividef(((double)((float)(((vx2 * (((((vy1 * x1) - (vy1 * x2)) - (vx1 * y1)) + (vx2 * y1)) - (vx1 * y2))) + (vy2 * ((((((-vx1) * x1) + (vx1 * x2)) - (vy1 * y1)) + (vy2 * y1)) - (vy1 * y2)))) + (y2 * ((vx1 * vx1) + (vy1 * vy1)))))), ((double)__cuda_local_var_16940_11_non_const_temp))));
# 63 "kernel_cuda.cu"
...
# 67 "kernel_cuda.cu"
(model_param[2]) = ((float)(fdividef(((double)((float)(((x1 - x2) * (vx1 - vx2)) + ((y1 - y2) * (vy1 - vy2))))), ((double)__cuda_local_var_16940_11_non_const_temp))));
# 68 "kernel_cuda.cu"
(model_param[3]) = ((float)(fdividef(((double)((float)(((x1 - x2) * (vy1 - vy2)) + ((y2 - y1) * (vx1 - vx2))))), ((double)__cuda_local_var_16940_11_non_const_temp))));
# 69 "kernel_cuda.cu"
return 1;
# 70 "kernel_cuda.cu"
}
...
# 90 "kernel_cuda.cu"
memset(((char *)(&__cuda_local_var_16982_17_non_const_p)), 0, 12UL);
# 90 "kernel_cuda.cu"
__cuda_local_var_16982_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , ((void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)(__float2int_rz(((double)((float)(((float)(__T20.n_tasks)) * alpha)))))))) : ((void)0)))) , __T20);
# 93 "kernel_cuda.cu"
...
# 138 "kernel_cuda.cu"
memset(((char *)(&__cuda_local_var_17030_24_non_const_fvreg)), 0, 16UL);
# 138 "kernel_cuda.cu"
__cuda_local_var_17030_24_non_const_fvreg = (flowvectors[i]);
# 139 "kernel_cuda.cu"
__cuda_local_var_16989_11_non_const_vx_error = ((float)(((__cuda_local_var_17030_24_non_const_fvreg.x) + (((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_17030_24_non_const_fvreg.x)) - (__cuda_local_var_16995_16_non_const_model_param[0])) * (__cuda_local_var_16995_16_non_const_model_param[2]))))))) - ((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_17030_24_non_const_fvreg.y)) - (__cuda_local_var_16995_16_non_const_model_param[1])) * (__cuda_local_var_16995_16_non_const_model_param[3]))))))))) - (__cuda_local_var_17030_24_non_const_fvreg.vx)));
# 142 "kernel_cuda.cu"
__cuda_local_var_16989_21_non_const_vy_error = ((float)(((__cuda_local_var_17030_24_non_const_fvreg.y) + (((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_17030_24_non_const_fvreg.y)) - (__cuda_local_var_16995_16_non_const_model_param[1])) * (__cuda_local_var_16995_16_non_const_model_param[2]))))))) + ((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_17030_24_non_const_fvreg.x)) - (__cuda_local_var_16995_16_non_const_model_param[0])) * (__cuda_local_var_16995_16_non_const_model_param[3]))))))))) - (__cuda_local_var_17030_24_non_const_fvreg.vy))); {
# 145 "kernel_cuda.cu"
if ((((float)(fabsf(((double)__cuda_local_var_16989_11_non_const_vx_error)))) >= ((float)error_threshold)) || (((float)(fabsf(((double)__cuda_local_var_16989_21_non_const_vy_error)))) >= ((float)error_threshold)))
# 145 "kernel_cuda.cu"
{
# 146 "kernel_cuda.cu"
