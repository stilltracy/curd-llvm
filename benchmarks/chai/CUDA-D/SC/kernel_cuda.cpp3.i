...
# 46 "kernel_cuda.cu"
extern void _Z6reducePiiS_(int *, int, int *);
# 64 "kernel_cuda.cu"
extern int _Z24block_binary_prefix_sumsPiiS_(int *, int, int *);
# 103 "kernel_cuda.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z23StreamCompaction_kerneliiifPiS_S_(int, int, int, float, int *, int *, int *);
# 110 "kernel_cuda.cu"
...
{
# 47 "kernel_cuda.cu"
 int __cuda_local_var_16194_15_non_const_tid;
# 48 "kernel_cuda.cu"
 int __cuda_local_var_16195_15_non_const_localSize;
# 47 "kernel_cuda.cu"
__cuda_local_var_16194_15_non_const_tid = ((int)(threadIdx.x));
# 48 "kernel_cuda.cu"
__cuda_local_var_16195_15_non_const_localSize = ((int)(blockDim.x));
# 50 "kernel_cuda.cu"
(l_data[__cuda_local_var_16194_15_non_const_tid]) = local_cnt;
# 51 "kernel_cuda.cu"
__syncthreads();
# 51 "kernel_cuda.cu"
{
# 53 "kernel_cuda.cu"
 int s;
# 53 "kernel_cuda.cu"
s = (__cuda_local_var_16195_15_non_const_localSize >> 1);
# 53 "kernel_cuda.cu"
for (; (s > 0); s >>= 1)
# 53 "kernel_cuda.cu"
{
# 54 "kernel_cuda.cu"
if (__cuda_local_var_16194_15_non_const_tid < s)
# 54 "kernel_cuda.cu"
{
# 55 "kernel_cuda.cu"
(l_data[__cuda_local_var_16194_15_non_const_tid]) += (l_data[(__cuda_local_var_16194_15_non_const_tid + s)]);
# 56 "kernel_cuda.cu"
}
# 57 "kernel_cuda.cu"
__syncthreads();
...
# 60 "kernel_cuda.cu"
if (__cuda_local_var_16194_15_non_const_tid == 0)
# 60 "kernel_cuda.cu"
{
# 61 "kernel_cuda.cu"
(*l_count) = (l_data[0]);
...
# 64 "kernel_cuda.cu"
 int _Z24block_binary_prefix_sumsPiiS_(
# 64 "kernel_cuda.cu"
int *l_count,
# 64 "kernel_cuda.cu"
int x,
...
{
# 66 "kernel_cuda.cu"
 int __cuda_local_var_16213_15_non_const_length;
# 68 "kernel_cuda.cu"
 int __cuda_local_var_16215_9_non_const_offset;
# 82 "kernel_cuda.cu"
 int __cuda_local_var_16229_9_non_const_maxThread;
# 94 "kernel_cuda.cu"
 int __cuda_local_var_16241_9_non_const_output;
# 65 "kernel_cuda.cu"
(l_data[(threadIdx.x)]) = x;
# 66 "kernel_cuda.cu"
__cuda_local_var_16213_15_non_const_length = ((int)(blockDim.x));
# 68 "kernel_cuda.cu"
__cuda_local_var_16215_9_non_const_offset = 1;
# 68 "kernel_cuda.cu"
{
# 69 "kernel_cuda.cu"
 int l;
# 69 "kernel_cuda.cu"
l = (__cuda_local_var_16213_15_non_const_length >> 1);
# 69 "kernel_cuda.cu"
for (; (l > 0); l >>= 1)
# 69 "kernel_cuda.cu"
{
...
__syncthreads();
# 71 "kernel_cuda.cu"
if ((threadIdx.x) < ((unsigned)l))
# 71 "kernel_cuda.cu"
{
# 72 "kernel_cuda.cu"
 int __cuda_local_var_16219_17_non_const_ai;
# 73 "kernel_cuda.cu"
 int __cuda_local_var_16220_17_non_const_bi;
# 72 "kernel_cuda.cu"
__cuda_local_var_16219_17_non_const_ai = ((int)((((unsigned)__cuda_local_var_16215_9_non_const_offset) * ((2U * (threadIdx.x)) + 1U)) - 1U));
# 73 "kernel_cuda.cu"
__cuda_local_var_16220_17_non_const_bi = ((int)((((unsigned)__cuda_local_var_16215_9_non_const_offset) * ((2U * (threadIdx.x)) + 2U)) - 1U));
# 74 "kernel_cuda.cu"
(l_data[__cuda_local_var_16220_17_non_const_bi]) += (l_data[__cuda_local_var_16219_17_non_const_ai]);
# 75 "kernel_cuda.cu"
}
# 76 "kernel_cuda.cu"
__cuda_local_var_16215_9_non_const_offset <<= 1;
...
# 78 "kernel_cuda.cu"
if (__cuda_local_var_16215_9_non_const_offset < __cuda_local_var_16213_15_non_const_length)
# 78 "kernel_cuda.cu"
{
# 79 "kernel_cuda.cu"
__cuda_local_var_16215_9_non_const_offset <<= 1;
...
# 82 "kernel_cuda.cu"
__cuda_local_var_16229_9_non_const_maxThread = (__cuda_local_var_16215_9_non_const_offset >> 1);
# 82 "kernel_cuda.cu"
{
# 83 "kernel_cuda.cu"
 int d;
...
d = 0;
# 83 "kernel_cuda.cu"
for (; (d < __cuda_local_var_16229_9_non_const_maxThread); d <<= 1)
# 83 "kernel_cuda.cu"
{
# 84 "kernel_cuda.cu"
d += 1;
...
{
# 88 "kernel_cuda.cu"
 int __cuda_local_var_16235_17_non_const_ai;
# 89 "kernel_cuda.cu"
 int __cuda_local_var_16236_17_non_const_bi;
# 88 "kernel_cuda.cu"
__cuda_local_var_16235_17_non_const_ai = ((int)((((unsigned)__cuda_local_var_16215_9_non_const_offset) * ((threadIdx.x) + 1U)) - 1U));
# 89 "kernel_cuda.cu"
__cuda_local_var_16236_17_non_const_bi = (__cuda_local_var_16235_17_non_const_ai + (__cuda_local_var_16215_9_non_const_offset >> 1));
# 90 "kernel_cuda.cu"
(l_data[__cuda_local_var_16236_17_non_const_bi]) += (l_data[__cuda_local_var_16235_17_non_const_ai]);
# 91 "kernel_cuda.cu"
}
# 92 "kernel_cuda.cu"
}
...
__syncthreads();
# 94 "kernel_cuda.cu"
__cuda_local_var_16241_9_non_const_output = (((l_data[(threadIdx.x)]) + (*l_count)) - x);
# 95 "kernel_cuda.cu"
__syncthreads();
# 96 "kernel_cuda.cu"
...
# 99 "kernel_cuda.cu"
return __cuda_local_var_16241_9_non_const_output;
# 100 "kernel_cuda.cu"
}
# 100 "kernel_cuda.cu"
}}
# 103 "kernel_cuda.cu"
__attribute__((global)) __attribute__((__used__)) void _Z23StreamCompaction_kerneliiifPiS_S_(
# 103 "kernel_cuda.cu"
int size,
# 103 "kernel_cuda.cu"
int value,
...
# 108 "kernel_cuda.cu"
 Partitioner __T20;
# 111 "kernel_cuda.cu"
 int *__cuda_local_var_16258_10_non_const_l_data;
# 112 "kernel_cuda.cu"
 int *__cuda_local_var_16259_10_non_const_l_count;
# 120 "kernel_cuda.cu"
 Partitioner __cuda_local_var_16267_17_non_const_p;
# 111 "kernel_cuda.cu"
__cuda_local_var_16258_10_non_const_l_data = l_mem;
# 112 "kernel_cuda.cu"
__cuda_local_var_16259_10_non_const_l_count = (__cuda_local_var_16258_10_non_const_l_data + (blockDim.x));
# 120 "kernel_cuda.cu"
memset(((char *)(&__cuda_local_var_16267_17_non_const_p)), 0, 12UL);
# 120 "kernel_cuda.cu"
__cuda_local_var_16267_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , ((void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)(__float2int_rz(((double)((float)(((float)(__T20.n_tasks)) * alpha)))))))) : ((void)0)))) , __T20);
# 120 "kernel_cuda.cu"
{
# 123 "kernel_cuda.cu"
 int my_s;
# 123 "kernel_cuda.cu"
my_s = (((__cuda_local_var_16267_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_16267_17_non_const_p.cut)) + (blockIdx.x)))) , (__cuda_local_var_16267_17_non_const_p.current));
# 123 "kernel_cuda.cu"
for (; ((__nv_bool)((((const Partitioner *)(&__cuda_local_var_16267_17_non_const_p))->current) < (((const Partitioner *)(&__cuda_local_var_16267_17_non_const_p))->n_tasks))); my_s = (((__cuda_local_var_16267_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_16267_17_non_const_p.current)) + (gridDim.x)))) , (__cuda_local_var_16267_17_non_const_p.current)))
# 123 "kernel_cuda.cu"
{
# 130 "kernel_cuda.cu"
 int __cuda_local_var_16277_13_non_const_local_cnt;
# 132 "kernel_cuda.cu"
 int __cuda_local_var_16279_13_non_const_reg[32];
# 136 "kernel_cuda.cu"
 int __cuda_local_var_16283_13_non_const_pos;
# 125 "kernel_cuda.cu"
if ((threadIdx.x) == 0U)
# 125 "kernel_cuda.cu"
{
# 126 "kernel_cuda.cu"
(__cuda_local_var_16259_10_non_const_l_count[0]) = 0;
# 127 "kernel_cuda.cu"
}
# 128 "kernel_cuda.cu"
__syncthreads();
# 130 "kernel_cuda.cu"
__cuda_local_var_16277_13_non_const_local_cnt = 0;
# 136 "kernel_cuda.cu"
__cuda_local_var_16283_13_non_const_pos = ((int)((((unsigned)((my_s - (__cuda_local_var_16267_17_non_const_p.cut)) * 32)) * (blockDim.x)) + (threadIdx.x)));
# 136 "kernel_cuda.cu"
{
# 140 "kernel_cuda.cu"
 int j;
...
{
# 141 "kernel_cuda.cu"
if (__cuda_local_var_16283_13_non_const_pos < size)
# 141 "kernel_cuda.cu"
{
# 142 "kernel_cuda.cu"
((__cuda_local_var_16279_13_non_const_reg)[j]) = (input[__cuda_local_var_16283_13_non_const_pos]);
# 143 "kernel_cuda.cu"
if (((__cuda_local_var_16279_13_non_const_reg)[j]) != value)
# 143 "kernel_cuda.cu"
{
# 144 "kernel_cuda.cu"
__cuda_local_var_16277_13_non_const_local_cnt++;
# 144 "kernel_cuda.cu"
}
# 145 "kernel_cuda.cu"
}
...
{
# 146 "kernel_cuda.cu"
((__cuda_local_var_16279_13_non_const_reg)[j]) = value;
# 146 "kernel_cuda.cu"
}
# 147 "kernel_cuda.cu"
__cuda_local_var_16283_13_non_const_pos += (blockDim.x);
# 148 "kernel_cuda.cu"
}
# 148 "kernel_cuda.cu"
}
# 149 "kernel_cuda.cu"
_Z6reducePiiS_((__cuda_local_var_16259_10_non_const_l_count + 0), __cuda_local_var_16277_13_non_const_local_cnt, (__cuda_local_var_16258_10_non_const_l_data + 0));
# 152 "kernel_cuda.cu"
if ((threadIdx.x) == 0U)
# 152 "kernel_cuda.cu"
{
# 153 "kernel_cuda.cu"
 int __cuda_local_var_16300_17_non_const_p_count;
# 159 "kernel_cuda.cu"
while ((__cuda_local_var_16300_17_non_const_p_count = (__iAtomicAdd((flags + my_s), 0))) == 0)
# 159 "kernel_cuda.cu"
{
# 160 "kernel_cuda.cu"
}
# 161 "kernel_cuda.cu"
_Z9atomicAddPii((flags + (my_s + 1)), (__cuda_local_var_16300_17_non_const_p_count + (__cuda_local_var_16259_10_non_const_l_count[0])));
# 163 "kernel_cuda.cu"
(__cuda_local_var_16259_10_non_const_l_count[0]) = (__cuda_local_var_16300_17_non_const_p_count - 1);
# 164 "kernel_cuda.cu"
}
# 165 "kernel_cuda.cu"
__syncthreads();
...
{
# 170 "kernel_cuda.cu"
__cuda_local_var_16283_13_non_const_pos = (_Z24block_binary_prefix_sumsPiiS_((__cuda_local_var_16259_10_non_const_l_count + 0), ((int)((((__cuda_local_var_16279_13_non_const_reg)[j]) != value) ? 1 : 0)), (__cuda_local_var_16258_10_non_const_l_data + 0)));
# 171 "kernel_cuda.cu"
if (((__cuda_local_var_16279_13_non_const_reg)[j]) != value)
# 171 "kernel_cuda.cu"
{
# 172 "kernel_cuda.cu"
(output[__cuda_local_var_16283_13_non_const_pos]) = ((__cuda_local_var_16279_13_non_const_reg)[j]);
# 173 "kernel_cuda.cu"
}
# 174 "kernel_cuda.cu"
}
