...
# 46 "kernel_cuda.cu"
extern __attribute__((device)) void _Z6reducePiiS_(int *, int, int *);
# 64 "kernel_cuda.cu"
extern __attribute__((device)) int _Z24block_binary_prefix_sumsPiiS_(int *, int, int *);
# 103 "kernel_cuda.cu"
__attribute__((global)) extern void _Z23StreamCompaction_kerneliiifPiS_S_(int, int, int, float, int *, int *, int *);
# 110 "kernel_cuda.cu"
...
# 46 "kernel_cuda.cu"
 __attribute__((device)) void _Z6reducePiiS_(
# 46 "kernel_cuda.cu"
int *l_count,
# 46 "kernel_cuda.cu"
int local_cnt,
...
# 64 "kernel_cuda.cu"
 __attribute__((device)) int _Z24block_binary_prefix_sumsPiiS_(
# 64 "kernel_cuda.cu"
int *l_count,
# 64 "kernel_cuda.cu"
int x,
...
# 103 "kernel_cuda.cu"
__attribute__((global)) void _Z23StreamCompaction_kerneliiifPiS_S_(
# 103 "kernel_cuda.cu"
int size,
# 103 "kernel_cuda.cu"
int value,
...
# 120 "kernel_cuda.cu"
memset((char *)&__cuda_local_var_16267_17_non_const_p, 0,sizeof(__cuda_local_var_16267_17_non_const_p));
# 120 "kernel_cuda.cu"
__cuda_local_var_16267_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , (void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)__float2int_rz((float)((((float)(__T20.n_tasks)) * alpha)))))) : ((void)0))) , __T20); {
# 123 "kernel_cuda.cu"
 int my_s;
# 123 "kernel_cuda.cu"
