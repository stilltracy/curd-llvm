...
# 76 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
static __inline__ int _Z9atomicAddPii(int *__T14, int __T15);
# 45 "kernel_cuda.cu"

# 45 "kernel_cuda.cu" 3
__attribute__((global)) __attribute__((__used__)) 
# 45 "kernel_cuda.cu"
                       extern void _Z19RANSAC_kernel_blockPfP10flowvectoriPiiifS2_S2_S2_(float *__T16, flowvector *__T17, int __T18, int *__T19, int __T110, int __T111, float __T112, int *__T113, int *__T114, int *__T115);
# 49 "kernel_cuda.cu"
extern 
# 49 "kernel_cuda.cu" 3
...
__attribute__((global)) __attribute__((__used__)) 
# 45 "kernel_cuda.cu"
                       void _Z19RANSAC_kernel_blockPfP10flowvectoriPiiifS2_S2_S2_(
# 45 "kernel_cuda.cu"
...
{
# 50 "kernel_cuda.cu"
 int *__cuda_local_var_16885_10_non_const_outlier_block_count;
# 52 "kernel_cuda.cu"
 int __cuda_local_var_16887_15_non_const_tx;
# 53 "kernel_cuda.cu"
 int __cuda_local_var_16888_15_non_const_bx;
# 54 "kernel_cuda.cu"
 int __cuda_local_var_16889_15_non_const_num_blocks;
# 56 "kernel_cuda.cu"
 float __cuda_local_var_16891_11_non_const_vx_error;
# 56 "kernel_cuda.cu"
 float __cuda_local_var_16891_21_non_const_vy_error;
# 57 "kernel_cuda.cu"
 int __cuda_local_var_16892_9_non_const_outlier_local_count;
# 50 "kernel_cuda.cu"
__cuda_local_var_16885_10_non_const_outlier_block_count = l_mem;
# 52 "kernel_cuda.cu"
__cuda_local_var_16887_15_non_const_tx = ((int)(threadIdx.x));
# 53 "kernel_cuda.cu"
__cuda_local_var_16888_15_non_const_bx = ((int)(blockIdx.x));
# 54 "kernel_cuda.cu"
__cuda_local_var_16889_15_non_const_num_blocks = ((int)(gridDim.x));
# 57 "kernel_cuda.cu"
__cuda_local_var_16892_9_non_const_outlier_local_count = 0;
# 57 "kernel_cuda.cu"
{
# 60 "kernel_cuda.cu"
 int loop_count;
# 60 "kernel_cuda.cu"
loop_count = __cuda_local_var_16888_15_non_const_bx; {
# 60 "kernel_cuda.cu"
for (; (loop_count < max_iter); loop_count += __cuda_local_var_16889_15_non_const_num_blocks)
# 60 "kernel_cuda.cu"
{
# 60 "kernel_cuda.cu"
{
# 62 "kernel_cuda.cu"
 float *__cuda_local_var_16897_16_non_const_model_param;
# 62 "kernel_cuda.cu"
__cuda_local_var_16897_16_non_const_model_param = (model_param_local + (4 * loop_count)); {
# 67 "kernel_cuda.cu"
if (__cuda_local_var_16887_15_non_const_tx == 0)
# 67 "kernel_cuda.cu"
{
# 68 "kernel_cuda.cu"
(__cuda_local_var_16885_10_non_const_outlier_block_count[0]) = 0;
# 69 "kernel_cuda.cu"
} }
# 70 "kernel_cuda.cu"
__syncthreads(); {
# 72 "kernel_cuda.cu"
if ((__cuda_local_var_16897_16_non_const_model_param[0]) == (-2011.0F))
# 72 "kernel_cuda.cu"
{
# 73 "kernel_cuda.cu"
goto __T20;
...
# 79 "kernel_cuda.cu"
 int i;
# 79 "kernel_cuda.cu"
i = __cuda_local_var_16887_15_non_const_tx; {
# 79 "kernel_cuda.cu"
for (; (i < flowvector_count); i += (blockDim.x))
# 79 "kernel_cuda.cu"
{
# 80 "kernel_cuda.cu"
 flowvector __cuda_local_var_16915_24_non_const_fvreg;
# 80 "kernel_cuda.cu"
memset(((char *)(&__cuda_local_var_16915_24_non_const_fvreg)), 0, 16UL);
# 80 "kernel_cuda.cu"
__cuda_local_var_16915_24_non_const_fvreg = (flowvectors[i]);
# 81 "kernel_cuda.cu"
__cuda_local_var_16891_11_non_const_vx_error = ((float)(((__cuda_local_var_16915_24_non_const_fvreg.x) + (((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_16915_24_non_const_fvreg.x)) - (__cuda_local_var_16897_16_non_const_model_param[0])) * (__cuda_local_var_16897_16_non_const_model_param[2]))))))) - ((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_16915_24_non_const_fvreg.y)) - (__cuda_local_var_16897_16_non_const_model_param[1])) * (__cuda_local_var_16897_16_non_const_model_param[3]))))))))) - (__cuda_local_var_16915_24_non_const_fvreg.vx)));
# 84 "kernel_cuda.cu"
__cuda_local_var_16891_21_non_const_vy_error = ((float)(((__cuda_local_var_16915_24_non_const_fvreg.y) + (((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_16915_24_non_const_fvreg.y)) - (__cuda_local_var_16897_16_non_const_model_param[1])) * (__cuda_local_var_16897_16_non_const_model_param[2]))))))) + ((int)(__float2int_rz(((double)((float)((((float)(__cuda_local_var_16915_24_non_const_fvreg.x)) - (__cuda_local_var_16897_16_non_const_model_param[0])) * (__cuda_local_var_16897_16_non_const_model_param[3]))))))))) - (__cuda_local_var_16915_24_non_const_fvreg.vy))); {
# 87 "kernel_cuda.cu"
if ((((float)(fabsf(((double)__cuda_local_var_16891_11_non_const_vx_error)))) >= ((float)error_threshold)) || (((float)(fabsf(((double)__cuda_local_var_16891_21_non_const_vy_error)))) >= ((float)error_threshold)))
# 87 "kernel_cuda.cu"
{
# 88 "kernel_cuda.cu"
__cuda_local_var_16892_9_non_const_outlier_local_count++;
# 89 "kernel_cuda.cu"
} }
# 90 "kernel_cuda.cu"
} }
...
# 92 "kernel_cuda.cu"
_Z9atomicAddPii((__cuda_local_var_16885_10_non_const_outlier_block_count + 0), __cuda_local_var_16892_9_non_const_outlier_local_count);
# 94 "kernel_cuda.cu"
__syncthreads(); {
# 95 "kernel_cuda.cu"
if (__cuda_local_var_16887_15_non_const_tx == 0)
...
{
# 97 "kernel_cuda.cu"
if (((float)(__cuda_local_var_16885_10_non_const_outlier_block_count[0])) < (((float)flowvector_count) * convergence_threshold))
# 97 "kernel_cuda.cu"
{
# 98 "kernel_cuda.cu"
 int __cuda_local_var_16933_21_non_const_index;
# 98 "kernel_cuda.cu"
__cuda_local_var_16933_21_non_const_index = (__iAtomicAdd(g_out_id, 1));
# 99 "kernel_cuda.cu"
(model_candidate[__cuda_local_var_16933_21_non_const_index]) = loop_count;
# 100 "kernel_cuda.cu"
(outliers_candidate[__cuda_local_var_16933_21_non_const_index]) = (__cuda_local_var_16885_10_non_const_outlier_block_count[0]);
# 101 "kernel_cuda.cu"
} }
# 102 "kernel_cuda.cu"
} }
