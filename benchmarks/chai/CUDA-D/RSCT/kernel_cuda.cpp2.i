...
# 45 "kernel_cuda.cu"
                       extern void _Z19RANSAC_kernel_blockPfP10flowvectoriPiiifS2_S2_S2_(float *, flowvector *, int, int *, int, int, float, int *, int *, int *);
# 49 "kernel_cuda.cu"
extern 
# 49 "kernel_cuda.cu" 3
...
# 80 "kernel_cuda.cu"
memset((char *)&__cuda_local_var_16915_24_non_const_fvreg, 0,sizeof(__cuda_local_var_16915_24_non_const_fvreg));
# 80 "kernel_cuda.cu"
__cuda_local_var_16915_24_non_const_fvreg = (flowvectors[i]);
# 81 "kernel_cuda.cu"
__cuda_local_var_16891_11_non_const_vx_error = ((float)(((__cuda_local_var_16915_24_non_const_fvreg.x) + (((int)__float2int_rz((float)(((((float)(__cuda_local_var_16915_24_non_const_fvreg.x)) - (__cuda_local_var_16897_16_non_const_model_param[0])) * (__cuda_local_var_16897_16_non_const_model_param[2]))))) - ((int)__float2int_rz((float)(((((float)(__cuda_local_var_16915_24_non_const_fvreg.y)) - (__cuda_local_var_16897_16_non_const_model_param[1])) * (__cuda_local_var_16897_16_non_const_model_param[3]))))))) - (__cuda_local_var_16915_24_non_const_fvreg.vx)));
# 84 "kernel_cuda.cu"
__cuda_local_var_16891_21_non_const_vy_error = ((float)(((__cuda_local_var_16915_24_non_const_fvreg.y) + (((int)__float2int_rz((float)(((((float)(__cuda_local_var_16915_24_non_const_fvreg.y)) - (__cuda_local_var_16897_16_non_const_model_param[1])) * (__cuda_local_var_16897_16_non_const_model_param[2]))))) + ((int)__float2int_rz((float)(((((float)(__cuda_local_var_16915_24_non_const_fvreg.x)) - (__cuda_local_var_16897_16_non_const_model_param[0])) * (__cuda_local_var_16897_16_non_const_model_param[3]))))))) - (__cuda_local_var_16915_24_non_const_fvreg.vy)));
# 87 "kernel_cuda.cu"
if (((fabsf(__cuda_local_var_16891_11_non_const_vx_error)) >= ((float)error_threshold)) || ((fabsf(__cuda_local_var_16891_21_non_const_vy_error)) >= ((float)error_threshold)))
# 87 "kernel_cuda.cu"
{
# 88 "kernel_cuda.cu"
