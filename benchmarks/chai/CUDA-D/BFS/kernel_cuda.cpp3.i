...
static __inline__ int _Z10atomicExchPii(int *, int);
# 46 "kernel_cuda.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z7BFS_gpuP4NodeP4EdgePiS3_S3_S3_S3_S3_S3_S3_S3_S3_S3_ii(Node *, Edge *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int, const int);
# 51 "kernel_cuda.cu"
...
# 96 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
static __inline__ int _Z10atomicExchPii(
# 96 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
int *address,
# 96 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
int val){
...
# 46 "kernel_cuda.cu"
__attribute__((global)) __attribute__((__used__)) void _Z7BFS_gpuP4NodeP4EdgePiS3_S3_S3_S3_S3_S3_S3_S3_S3_S3_ii(
# 46 "kernel_cuda.cu"
Node *graph_nodes_av,
# 46 "kernel_cuda.cu"
Edge *graph_edges_av,
...
# 76 "kernel_cuda.cu"
 int __cuda_local_var_16174_9_non_const_my_base;
# 112 "kernel_cuda.cu"
 int __cuda_local_var_16210_9_non_const_local_shift;
# 52 "kernel_cuda.cu"
...
__syncthreads();
# 76 "kernel_cuda.cu"
__cuda_local_var_16174_9_non_const_my_base = (*__cuda_local_var_16153_10_non_const_base);
# 77 "kernel_cuda.cu"
while (__cuda_local_var_16174_9_non_const_my_base < __cuda_local_var_16162_9_non_const_n_t_local)
# 77 "kernel_cuda.cu"
{
# 78 "kernel_cuda.cu"
if (((__cuda_local_var_16174_9_non_const_my_base + __cuda_local_var_16155_15_non_const_tid) < __cuda_local_var_16162_9_non_const_n_t_local) && ((*overflow) == 0))
# 78 "kernel_cuda.cu"
{
# 80 "kernel_cuda.cu"
 int __cuda_local_var_16178_17_non_const_pid;
# 83 "kernel_cuda.cu"
 Node __cuda_local_var_16181_18_non_const_cur_node;
# 80 "kernel_cuda.cu"
__cuda_local_var_16178_17_non_const_pid = (q1[(__cuda_local_var_16174_9_non_const_my_base + __cuda_local_var_16155_15_non_const_tid)]);
# 82 "kernel_cuda.cu"
_Z10atomicExchPii((cost + __cuda_local_var_16178_17_non_const_pid), __cuda_local_var_16160_9_non_const_iter_local);
# 84 "kernel_cuda.cu"
(__cuda_local_var_16181_18_non_const_cur_node.x) = ((graph_nodes_av[__cuda_local_var_16178_17_non_const_pid]).x);
# 85 "kernel_cuda.cu"
(__cuda_local_var_16181_18_non_const_cur_node.y) = ((graph_nodes_av[__cuda_local_var_16178_17_non_const_pid]).y);
# 85 "kernel_cuda.cu"
{
# 87 "kernel_cuda.cu"
 int i;
# 87 "kernel_cuda.cu"
i = (__cuda_local_var_16181_18_non_const_cur_node.x);
# 87 "kernel_cuda.cu"
for (; (i < ((__cuda_local_var_16181_18_non_const_cur_node.y) + (__cuda_local_var_16181_18_non_const_cur_node.x))); i++)
# 87 "kernel_cuda.cu"
{
# 88 "kernel_cuda.cu"
 int __cuda_local_var_16186_21_non_const_id;
# 89 "kernel_cuda.cu"
 int __cuda_local_var_16187_21_non_const_old_color;
# 88 "kernel_cuda.cu"
__cuda_local_var_16186_21_non_const_id = ((graph_edges_av[i]).x);
# 89 "kernel_cuda.cu"
__cuda_local_var_16187_21_non_const_old_color = (__iAtomicMax((color + __cuda_local_var_16186_21_non_const_id), 16677221));
# 90 "kernel_cuda.cu"
if (__cuda_local_var_16187_21_non_const_old_color < 16677221)
# 90 "kernel_cuda.cu"
{
# 92 "kernel_cuda.cu"
 int __cuda_local_var_16190_25_non_const_tail_index;
# 92 "kernel_cuda.cu"
__cuda_local_var_16190_25_non_const_tail_index = (__iAtomicAdd(__cuda_local_var_16150_10_non_const_tail_bin, 1));
# 93 "kernel_cuda.cu"
if (__cuda_local_var_16190_25_non_const_tail_index >= 1600)
# 93 "kernel_cuda.cu"
{
# 94 "kernel_cuda.cu"
(*overflow) = 1;
...
{
# 96 "kernel_cuda.cu"
(__cuda_local_var_16151_10_non_const_l_q2[__cuda_local_var_16190_25_non_const_tail_index]) = __cuda_local_var_16186_21_non_const_id;
# 96 "kernel_cuda.cu"
}
# 97 "kernel_cuda.cu"
}
...
__syncthreads();
# 112 "kernel_cuda.cu"
__cuda_local_var_16210_9_non_const_local_shift = __cuda_local_var_16155_15_non_const_tid;
# 113 "kernel_cuda.cu"
while (__cuda_local_var_16210_9_non_const_local_shift < (*__cuda_local_var_16150_10_non_const_tail_bin))
# 113 "kernel_cuda.cu"
{
# 114 "kernel_cuda.cu"
(q2[((*__cuda_local_var_16152_10_non_const_shift) + __cuda_local_var_16210_9_non_const_local_shift)]) = (__cuda_local_var_16151_10_non_const_l_q2[__cuda_local_var_16210_9_non_const_local_shift]);
# 116 "kernel_cuda.cu"
__cuda_local_var_16210_9_non_const_local_shift += __cuda_local_var_16158_15_non_const_WG_SIZE;
# 117 "kernel_cuda.cu"
}
# 120 "kernel_cuda.cu"
