...
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"

# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
static __inline__ unsigned _Z9atomicAddPjj(unsigned *__T14, unsigned __T15);
# 46 "kernel_cuda.cu"

# 46 "kernel_cuda.cu" 3
__attribute__((global)) __attribute__((__used__)) 
# 46 "kernel_cuda.cu"
                       extern void _Z16Histogram_kerneliiifPjS_(int __T16, int __T17, int __T18, float __T19, unsigned *__T110, unsigned *__T111);
# 53 "kernel_cuda.cu"
extern 
# 53 "kernel_cuda.cu" 3
...
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
static __inline__ unsigned _Z9atomicAddPjj(
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
unsigned *address,
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
unsigned val){
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
{
# 82 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
{
# 83 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
return __uAtomicAdd(address, val);
# 84 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
}
# 84 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
}}
# 46 "kernel_cuda.cu"
...
__attribute__((global)) __attribute__((__used__)) 
# 46 "kernel_cuda.cu"
                       void _Z16Histogram_kerneliiifPjS_(
# 46 "kernel_cuda.cu"
int size,
# 46 "kernel_cuda.cu"
int bins,
...
# 51 "kernel_cuda.cu"
 Partitioner __T20;
# 54 "kernel_cuda.cu"
 unsigned *__cuda_local_var_16939_19_non_const_l_histo;
# 62 "kernel_cuda.cu"
 Partitioner __cuda_local_var_16947_17_non_const_p;
# 66 "kernel_cuda.cu"
 int __cuda_local_var_16951_15_non_const_bx;
# 67 "kernel_cuda.cu"
 int __cuda_local_var_16952_15_non_const_tx;
# 68 "kernel_cuda.cu"
 int __cuda_local_var_16953_15_non_const_bD;
# 69 "kernel_cuda.cu"
 int __cuda_local_var_16954_15_non_const_gD;
# 54 "kernel_cuda.cu"
__cuda_local_var_16939_19_non_const_l_histo = l_mem;
# 62 "kernel_cuda.cu"
memset(((char *)(&__cuda_local_var_16947_17_non_const_p)), 0, 12UL);
# 62 "kernel_cuda.cu"
__cuda_local_var_16947_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , ((void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)(__float2int_rz(((double)((float)(((float)(__T20.n_tasks)) * alpha)))))))) : ((void)0)))) , __T20);
# 66 "kernel_cuda.cu"
__cuda_local_var_16951_15_non_const_bx = ((int)(blockIdx.x));
# 67 "kernel_cuda.cu"
__cuda_local_var_16952_15_non_const_tx = ((int)(threadIdx.x));
# 68 "kernel_cuda.cu"
__cuda_local_var_16953_15_non_const_bD = ((int)(blockDim.x));
# 69 "kernel_cuda.cu"
__cuda_local_var_16954_15_non_const_gD = ((int)(gridDim.x));
# 69 "kernel_cuda.cu"
{
# 72 "kernel_cuda.cu"
 int pos;
# 72 "kernel_cuda.cu"
pos = __cuda_local_var_16952_15_non_const_tx; {
# 72 "kernel_cuda.cu"
for (; (pos < bins); pos += __cuda_local_var_16953_15_non_const_bD)
# 72 "kernel_cuda.cu"
{
# 73 "kernel_cuda.cu"
(__cuda_local_var_16939_19_non_const_l_histo[pos]) = 0U;
# 74 "kernel_cuda.cu"
} }
# 74 "kernel_cuda.cu"
}
...
# 79 "kernel_cuda.cu"
 int i;
# 79 "kernel_cuda.cu"
i = (((__cuda_local_var_16947_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_16947_17_non_const_p.cut)) + (blockIdx.x)))) , (__cuda_local_var_16947_17_non_const_p.current)); {
# 79 "kernel_cuda.cu"
for (; ((__nv_bool)((((const Partitioner *)(&__cuda_local_var_16947_17_non_const_p))->current) < (((const Partitioner *)(&__cuda_local_var_16947_17_non_const_p))->n_tasks))); i = (((__cuda_local_var_16947_17_non_const_p.current) = ((int)(((unsigned)(__cuda_local_var_16947_17_non_const_p.current)) + (gridDim.x)))) , (__cuda_local_var_16947_17_non_const_p.current)))
# 79 "kernel_cuda.cu"
{
# 82 "kernel_cuda.cu"
 unsigned __cuda_local_var_16967_22_non_const_d;
# 82 "kernel_cuda.cu"
__cuda_local_var_16967_22_non_const_d = (data[((i * __cuda_local_var_16953_15_non_const_bD) + __cuda_local_var_16952_15_non_const_tx)]);
# 85 "kernel_cuda.cu"
_Z9atomicAddPjj((__cuda_local_var_16939_19_non_const_l_histo + ((__cuda_local_var_16967_22_non_const_d * ((unsigned)bins)) >> 12)), 1U);
# 86 "kernel_cuda.cu"
} }
# 86 "kernel_cuda.cu"
}
...
{
# 96 "kernel_cuda.cu"
_Z9atomicAddPjj((histo + pos), (__cuda_local_var_16939_19_non_const_l_histo[pos]));
# 98 "kernel_cuda.cu"
} }
# 98 "kernel_cuda.cu"
}
