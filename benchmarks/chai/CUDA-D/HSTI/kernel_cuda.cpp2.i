...
# 82 "/opt/nvidia8/bin/..//include/device_atomic_functions.h" 3
__attribute__((device_builtin)) 
# 82 "/opt/nvidia8/bin/..//include/device_atomic_functions.h"
                   extern 
# 82 "/opt/nvidia8/bin/..//include/device_atomic_functions.h" 3
...
static 
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp" 3
__attribute__((device)) 
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
                              __inline__ unsigned _Z9atomicAddPjj(unsigned *, unsigned);
# 46 "kernel_cuda.cu"

# 46 "kernel_cuda.cu" 3
__attribute__((global)) 
# 46 "kernel_cuda.cu"
                       extern void _Z16Histogram_kerneliiifPjS_(int, int, int, float, unsigned *, unsigned *);
# 53 "kernel_cuda.cu"
extern 
# 53 "kernel_cuda.cu" 3
...
__attribute__((device)) 
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
                              __inline__ unsigned _Z9atomicAddPjj(
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
unsigned *address,
# 81 "/opt/nvidia8/bin/..//include/device_atomic_functions.hpp"
unsigned val){
...
# 62 "kernel_cuda.cu"
memset((char *)&__cuda_local_var_16947_17_non_const_p, 0,sizeof(__cuda_local_var_16947_17_non_const_p));
# 62 "kernel_cuda.cu"
__cuda_local_var_16947_17_non_const_p = ((((__T20.n_tasks) = n_tasks) , (void)(((((double)alpha) >= (0.0)) && (((double)alpha) <= (1.0))) ? ((void)((__T20.cut) = ((int)__float2int_rz((float)((((float)(__T20.n_tasks)) * alpha)))))) : ((void)0))) , __T20);
# 66 "kernel_cuda.cu"
