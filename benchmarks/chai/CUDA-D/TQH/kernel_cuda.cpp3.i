...
# 45 "kernel_cuda.cu"
                       extern void _Z15TQHistogram_gpuP6task_tPiS1_iiS1_ii(task_t *__T16, int *__T17, int *__T18, int __T19, int __T110, int *__T111, int __T112, int __T113);
# 48 "kernel_cuda.cu"
extern 
# 48 "kernel_cuda.cu" 3
...
__attribute__((global)) __attribute__((__used__)) 
# 45 "kernel_cuda.cu"
                       void _Z15TQHistogram_gpuP6task_tPiS1_iiS1_ii(
# 45 "kernel_cuda.cu"
task_t *queue,
# 45 "kernel_cuda.cu"
int *data,
...
{
# 49 "kernel_cuda.cu"
 int *__cuda_local_var_16882_10_non_const_next;
# 50 "kernel_cuda.cu"
 task_t *__cuda_local_var_16883_13_non_const_t;
# 51 "kernel_cuda.cu"
 int *__cuda_local_var_16884_10_non_const_l_histo;
# 53 "kernel_cuda.cu"
 int __cuda_local_var_16886_15_non_const_tid;
# 54 "kernel_cuda.cu"
 int __cuda_local_var_16887_15_non_const_tileid;
# 55 "kernel_cuda.cu"
 int __cuda_local_var_16888_15_non_const_tile_size;
# 49 "kernel_cuda.cu"
__cuda_local_var_16882_10_non_const_next = l_mem;
# 50 "kernel_cuda.cu"
__cuda_local_var_16883_13_non_const_t = ((task_t *)(__cuda_local_var_16882_10_non_const_next + 1));
# 51 "kernel_cuda.cu"
__cuda_local_var_16884_10_non_const_l_histo = ((int *)(__cuda_local_var_16883_13_non_const_t + 1));
# 53 "kernel_cuda.cu"
__cuda_local_var_16886_15_non_const_tid = ((int)(threadIdx.x));
# 54 "kernel_cuda.cu"
__cuda_local_var_16887_15_non_const_tileid = ((int)(blockIdx.x));
# 55 "kernel_cuda.cu"
__cuda_local_var_16888_15_non_const_tile_size = ((int)(blockDim.x)); {
# 58 "kernel_cuda.cu"
if (__cuda_local_var_16886_15_non_const_tid == 0)
# 58 "kernel_cuda.cu"
{
# 59 "kernel_cuda.cu"
(*__cuda_local_var_16882_10_non_const_next) = (__iAtomicAdd(consumed, 1));
# 60 "kernel_cuda.cu"
(__cuda_local_var_16883_13_non_const_t->id) = ((queue[(*__cuda_local_var_16882_10_non_const_next)]).id);
# 61 "kernel_cuda.cu"
(__cuda_local_var_16883_13_non_const_t->op) = ((queue[(*__cuda_local_var_16882_10_non_const_next)]).op);
# 62 "kernel_cuda.cu"
} }
# 63 "kernel_cuda.cu"
__syncthreads(); {
# 65 "kernel_cuda.cu"
while ((*__cuda_local_var_16882_10_non_const_next) < gpuQueueSize)
# 65 "kernel_cuda.cu"
{
# 65 "kernel_cuda.cu"
{
# 67 "kernel_cuda.cu"
if ((__cuda_local_var_16883_13_non_const_t->op) == 1)
# 67 "kernel_cuda.cu"
{
# 67 "kernel_cuda.cu"
{
# 69 "kernel_cuda.cu"
 int i;
# 69 "kernel_cuda.cu"
i = __cuda_local_var_16886_15_non_const_tid; {
# 69 "kernel_cuda.cu"
for (; (i < n_bins); i += __cuda_local_var_16888_15_non_const_tile_size)
# 69 "kernel_cuda.cu"
{
# 70 "kernel_cuda.cu"
(__cuda_local_var_16884_10_non_const_l_histo[i]) = 0;
# 71 "kernel_cuda.cu"
} }
# 71 "kernel_cuda.cu"
}
...
i = __cuda_local_var_16886_15_non_const_tid; {
# 74 "kernel_cuda.cu"
for (; (i < frame_size); i += __cuda_local_var_16888_15_non_const_tile_size)
# 74 "kernel_cuda.cu"
{
# 75 "kernel_cuda.cu"
 int __cuda_local_var_16908_21_non_const_value;
# 75 "kernel_cuda.cu"
__cuda_local_var_16908_21_non_const_value = (((data[((((__cuda_local_var_16883_13_non_const_t->id) - offset) * frame_size) + i)]) * n_bins) >> 8);
# 77 "kernel_cuda.cu"
_Z9atomicAddPii((__cuda_local_var_16884_10_non_const_l_histo + __cuda_local_var_16908_21_non_const_value), 1);
# 78 "kernel_cuda.cu"
} }
# 78 "kernel_cuda.cu"
}
...
{
# 83 "kernel_cuda.cu"
(histo[((((__cuda_local_var_16883_13_non_const_t->id) - offset) * n_bins) + i)]) = (__cuda_local_var_16884_10_non_const_l_histo[i]);
# 84 "kernel_cuda.cu"
} }
# 84 "kernel_cuda.cu"
}
